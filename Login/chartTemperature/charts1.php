...
$IDSensor8 = array();
$IDSensor9 = array();
$TemperatureSensor1 = array();
$TemperatureSensor2 = array();
$TemperatureSensor3 = array();
$TemperatureSensor4 = array();
$TemperatureSensor5 = array();
$TemperatureSensor6 = array();
$TemperatureSensor7 = array();
$TemperatureSensor8 = array();
$TemperatureSensor9 = array();
...
if ($resultSqlSensor1 = mysqli_query($link, $sqlSensor1)) {
    if (mysqli_num_rows($resultSqlSensor1) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor1)) {
            ...
            $TemperatureSensor1[] = (float)$row['Suhu'];
        }
        // Free result set
...
if ($resultSqlSensor2 = mysqli_query($link, $sqlSensor2)) {
    if (mysqli_num_rows($resultSqlSensor2) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor2)) {
            ...
            $TemperatureSensor2[] = (float)$row['Suhu'];
        }
        // Free result set
...
if ($resultSqlSensor3 = mysqli_query($link, $sqlSensor3)) {
    if (mysqli_num_rows($resultSqlSensor3) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor3)) {
            ...
            $TemperatureSensor3[] = (float)$row['Suhu'];
        }
        // Free result set
...
if ($resultSqlSensor4 = mysqli_query($link, $sqlSensor4)) {
    if (mysqli_num_rows($resultSqlSensor4) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor4)) {
            ...
            $TemperatureSensor4[] = (float)$row['Suhu'];
        }
        // Free result set
...
if ($resultSqlSensor5 = mysqli_query($link, $sqlSensor5)) {
    if (mysqli_num_rows($resultSqlSensor5) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor5)) {
            ...
            $TemperatureSensor5[] = (float)$row['Suhu'];
        }
        // Free result set
...
if ($resultSqlSensor6 = mysqli_query($link, $sqlSensor6)) {
    if (mysqli_num_rows($resultSqlSensor6) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor6)) {
            ...
            $TemperatureSensor6[] = (float)$row['Suhu'];
        }
        // Free result set
...
if ($resultSqlSensor7 = mysqli_query($link, $sqlSensor7)) {
    if (mysqli_num_rows($resultSqlSensor7) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor7)) {
            ...
            $TemperatureSensor7[] = (float)$row['Suhu'];
        }
        // Free result set
...
if ($resultSqlSensor8 = mysqli_query($link, $sqlSensor8)) {
    if (mysqli_num_rows($resultSqlSensor8) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor8)) {
            ...
            $TemperatureSensor8[] = (float)$row['Suhu'];
        }
        // Free result set
...
if ($resultSqlSensor9 = mysqli_query($link, $sqlSensor9)) {
    if (mysqli_num_rows($resultSqlSensor9) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor9)) {
            ...
            $TemperatureSensor9[] = (float)$row['Suhu'];
        }
        // Free result set
        ...
        document.addEventListener('DOMContentLoaded', function () {
            Highcharts.chart('container', {
                ...
                series: [{
                    ...
                    data: <?php echo json_encode($TemperatureSensor1); ?>,
                    accessibility: {
                ...
                }, 
                {
                    ...
                    data: <?php echo json_encode($TemperatureSensor2); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($TemperatureSensor3); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($TemperatureSensor4); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($TemperatureSensor5); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($TemperatureSensor6); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($TemperatureSensor7); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($TemperatureSensor8); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($TemperatureSensor9); ?>,
                    accessibility: {
