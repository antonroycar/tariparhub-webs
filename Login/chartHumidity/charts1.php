...
$IDSensor8 = array();
$IDSensor9 = array();
$KelembabanSensor1 = array();
$KelembabanSensor2 = array();
$KelembabanSensor3 = array();
$KelembabanSensor4 = array();
$KelembabanSensor5 = array();
$KelembabanSensor6 = array();
$KelembabanSensor7 = array();
$KelembabanSensor8 = array();
$KelembabanSensor9 = array();
...
if ($resultSqlSensor1 = mysqli_query($link, $sqlSensor1)) {
    if (mysqli_num_rows($resultSqlSensor1) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor1)) {
            ...
            $KelembabanSensor1[] = (float)$row['Kelembaban'];
        }
        // Free result set
...
if ($resultSqlSensor2 = mysqli_query($link, $sqlSensor2)) {
    if (mysqli_num_rows($resultSqlSensor2) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor2)) {
            ...
            $KelembabanSensor2[] = (float)$row['Kelembaban'];
        }
        // Free result set
...
if ($resultSqlSensor3 = mysqli_query($link, $sqlSensor3)) {
    if (mysqli_num_rows($resultSqlSensor3) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor3)) {
            ...
            $KelembabanSensor3[] = (float)$row['Kelembaban'];
        }
        // Free result set
...
if ($resultSqlSensor4 = mysqli_query($link, $sqlSensor4)) {
    if (mysqli_num_rows($resultSqlSensor4) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor4)) {
            ...
            $KelembabanSensor4[] = (float)$row['Kelembaban'];
        }
        // Free result set
...
if ($resultSqlSensor5 = mysqli_query($link, $sqlSensor5)) {
    if (mysqli_num_rows($resultSqlSensor5) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor5)) {
            ...
            $KelembabanSensor5[] = (float)$row['Kelembaban'];
        }
        // Free result set
...
if ($resultSqlSensor6 = mysqli_query($link, $sqlSensor6)) {
    if (mysqli_num_rows($resultSqlSensor6) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor6)) {
            ...
            $KelembabanSensor6[] = (float)$row['Kelembaban'];
        }
        // Free result set
...
if ($resultSqlSensor7 = mysqli_query($link, $sqlSensor7)) {
    if (mysqli_num_rows($resultSqlSensor7) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor7)) {
            ...
            $KelembabanSensor7[] = (float)$row['Kelembaban'];
        }
        // Free result set
...
if ($resultSqlSensor8 = mysqli_query($link, $sqlSensor8)) {
    if (mysqli_num_rows($resultSqlSensor8) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor8)) {
            ...
            $KelembabanSensor8[] = (float)$row['Kelembaban'];
        }
        // Free result set
...
if ($resultSqlSensor9 = mysqli_query($link, $sqlSensor9)) {
    if (mysqli_num_rows($resultSqlSensor9) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor9)) {
            ...
            $KelembabanSensor9[] = (float)$row['Kelembaban'];
        }
        // Free result set
        ...
        document.addEventListener('DOMContentLoaded', function () {
            Highcharts.chart('container', {
                ...
                series: [{
                    ...
                    data: <?php echo json_encode($KelembabanSensor1); ?>,
                    accessibility: {
                ...
                }, 
                {
                    ...
                    data: <?php echo json_encode($KelembabanSensor2); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($KelembabanSensor3); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($KelembabanSensor4); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($KelembabanSensor5); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($KelembabanSensor6); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($KelembabanSensor7); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($KelembabanSensor8); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($KelembabanSensor9); ?>,
                    accessibility: {
