...
$IDSensor8 = array();
$IDSensor9 = array();
$PhosphorusSensor1 = array();
$PhosphorusSensor2 = array();
$PhosphorusSensor3 = array();
$PhosphorusSensor4 = array();
$PhosphorusSensor5 = array();
$PhosphorusSensor6 = array();
$PhosphorusSensor7 = array();
$PhosphorusSensor8 = array();
$PhosphorusSensor9 = array();
...
if ($resultSqlSensor1 = mysqli_query($link, $sqlSensor1)) {
    if (mysqli_num_rows($resultSqlSensor1) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor1)) {
            ...
            $PhosphorusSensor1[] = (float)$row['Phosphorus'];
        }
        // Free result set
...
if ($resultSqlSensor2 = mysqli_query($link, $sqlSensor2)) {
    if (mysqli_num_rows($resultSqlSensor2) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor2)) {
            ...
            $PhosphorusSensor2[] = (float)$row['Phosphorus'];
        }
        // Free result set
...
if ($resultSqlSensor3 = mysqli_query($link, $sqlSensor3)) {
    if (mysqli_num_rows($resultSqlSensor3) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor3)) {
            ...
            $PhosphorusSensor3[] = (float)$row['Phosphorus'];
        }
        // Free result set
...
if ($resultSqlSensor4 = mysqli_query($link, $sqlSensor4)) {
    if (mysqli_num_rows($resultSqlSensor4) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor4)) {
            ...
            $PhosphorusSensor4[] = (float)$row['Phosphorus'];
        }
        // Free result set
...
if ($resultSqlSensor5 = mysqli_query($link, $sqlSensor5)) {
    if (mysqli_num_rows($resultSqlSensor5) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor5)) {
            ...
            $PhosphorusSensor5[] = (float)$row['Phosphorus'];
        }
        // Free result set
...
if ($resultSqlSensor6 = mysqli_query($link, $sqlSensor6)) {
    if (mysqli_num_rows($resultSqlSensor6) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor6)) {
            ...
            $PhosphorusSensor6[] = (float)$row['Phosphorus'];
        }
        // Free result set
...
if ($resultSqlSensor7 = mysqli_query($link, $sqlSensor7)) {
    if (mysqli_num_rows($resultSqlSensor7) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor7)) {
            ...
            $PhosphorusSensor7[] = (float)$row['Phosphorus'];
        }
        // Free result set
...
if ($resultSqlSensor8 = mysqli_query($link, $sqlSensor8)) {
    if (mysqli_num_rows($resultSqlSensor8) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor8)) {
            ...
            $PhosphorusSensor8[] = (float)$row['Phosphorus'];
        }
        // Free result set
...
if ($resultSqlSensor9 = mysqli_query($link, $sqlSensor9)) {
    if (mysqli_num_rows($resultSqlSensor9) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor9)) {
            ...
            $PhosphorusSensor9[] = (float)$row['Phosphorus'];
        }
        // Free result set
        ...
        document.addEventListener('DOMContentLoaded', function () {
            Highcharts.chart('container', {
                ...
                series: [{
                    ...
                    data: <?php echo json_encode($PhosphorusSensor1); ?>,
                    accessibility: {
                ...
                }, 
                {
                    ...
                    data: <?php echo json_encode($PhosphorusSensor2); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($PhosphorusSensor3); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($PhosphorusSensor4); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($PhosphorusSensor5); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($PhosphorusSensor6); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($PhosphorusSensor7); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($PhosphorusSensor8); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($PhosphorusSensor9); ?>,
                    accessibility: {
