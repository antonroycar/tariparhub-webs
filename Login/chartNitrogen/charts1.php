...
$IDSensor8 = array();
$IDSensor9 = array();
$nitrogenDataSensor1 = array();
$nitrogenDataSensor2 = array();
$nitrogenDataSensor3 = array();
$nitrogenDataSensor4 = array();
$nitrogenDataSensor5 = array();
$nitrogenDataSensor6 = array();
$nitrogenDataSensor7 = array();
$nitrogenDataSensor8 = array();
$nitrogenDataSensor9 = array();
...
if ($resultSqlSensor1 = mysqli_query($link, $sqlSensor1)) {
    if (mysqli_num_rows($resultSqlSensor1) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor1)) {
            ...
            $nitrogenDataSensor1[] = (float)$row['Nitrogen'];
        }
        // Free result set
...
if ($resultSqlSensor2 = mysqli_query($link, $sqlSensor2)) {
    if (mysqli_num_rows($resultSqlSensor2) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor2)) {
            ...
            $nitrogenDataSensor2[] = (float)$row['Nitrogen'];
        }
        // Free result set
...
if ($resultSqlSensor3 = mysqli_query($link, $sqlSensor3)) {
    if (mysqli_num_rows($resultSqlSensor3) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor3)) {
            ...
            $nitrogenDataSensor3[] = (float)$row['Nitrogen'];
        }
        // Free result set
...
if ($resultSqlSensor4 = mysqli_query($link, $sqlSensor4)) {
    if (mysqli_num_rows($resultSqlSensor4) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor4)) {
            ...
            $nitrogenDataSensor4[] = (float)$row['Nitrogen'];
        }
        // Free result set
...
if ($resultSqlSensor5 = mysqli_query($link, $sqlSensor5)) {
    if (mysqli_num_rows($resultSqlSensor5) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor5)) {
            ...
            $nitrogenDataSensor5[] = (float)$row['Nitrogen'];
        }
        // Free result set
...
if ($resultSqlSensor6 = mysqli_query($link, $sqlSensor6)) {
    if (mysqli_num_rows($resultSqlSensor6) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor6)) {
            ...
            $nitrogenDataSensor6[] = (float)$row['Nitrogen'];
        }
        // Free result set
...
if ($resultSqlSensor7 = mysqli_query($link, $sqlSensor7)) {
    if (mysqli_num_rows($resultSqlSensor7) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor7)) {
            ...
            $nitrogenDataSensor7[] = (float)$row['Nitrogen'];
        }
        // Free result set
...
if ($resultSqlSensor8 = mysqli_query($link, $sqlSensor8)) {
    if (mysqli_num_rows($resultSqlSensor8) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor8)) {
            ...
            $nitrogenDataSensor8[] = (float)$row['Nitrogen'];
        }
        // Free result set
...
if ($resultSqlSensor9 = mysqli_query($link, $sqlSensor9)) {
    if (mysqli_num_rows($resultSqlSensor9) > 0) {
        while ($row = mysqli_fetch_assoc($resultSqlSensor9)) {
            ...
            $nitrogenDataSensor9[] = (float)$row['Nitrogen'];
        }
        // Free result set
        ...
        document.addEventListener('DOMContentLoaded', function () {
            Highcharts.chart('container', {
                ...
                series: [{
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor1); ?>,
                    accessibility: {
                ...
                }, 
                {
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor2); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor3); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor4); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor5); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor6); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor7); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor8); ?>,
                    accessibility: {
                    ...
                    data: <?php echo json_encode($nitrogenDataSensor9); ?>,
                    accessibility: {
